...
1. Control of Density: Inside the system, hyperacceleration of `9. Process` is initiated, which leads to extreme growth of `11. Tempo of Processes` (`Tp`). According to the formula

$$T_p = \frac{E_v}{P_r}$$

the local density of events increases relative to the external background.

2. Inversion of Metric Consistency: `11. Tempo of Processes` determines `15. Metric` (computational consistency). Upon reaching the critical threshold of `Tp` inside the contour, the local `15. Metric` ceases to correspond to the external one, which nullifies the gradient of `18. Gravitation`.

3. Metric Propulsion: Since
...
<img width="1536" height="1024" alt="image" src="https://github.com/user-attachments/assets/9782928c-47f2-4f6f-b4af-2a45ffd7af8b" />
